...
class AdminPricingController extends BaseController {
    ...
    public function postEdit() {
        ...
        if ($item == '') {
            ...
            if ($edit == 'success') {
                return Redirect::to('adminPricing/index/')->with('flash_message', 'Items edited');
            } else {
    ...
    public function postDelete() {
        ...
        if ($delete == 'success') {
            return Redirect::to('adminPricing/index/')->with('flash_message', 'Item deleted');
        } else {
    ...
    public function postCreate() {
        ...
        if ($item == '') {
            ...
            if ($create == 'success') {
                return Redirect::to('adminPricing/index/')->with('flash_message', 'item created');
            } else {
    ...
    public function postEditScheme() {
        ...
        if ($scheme == '') {
            ...
            if ($edit == 'success') {
                return Redirect::to('adminPricing/index/')->with('flash_message', 'Schemes edited');
            } else {
    ...
    public function postDeleteScheme() {
        ...
        if ($delete == 'success') {
            return Redirect::to('adminPricing/index/')->with('flash_message', 'Schemes deleted');
        } else {
    ...
    public function postCreateScheme() {
        ...
        if ($scheme == '') {
            ...
            if ($create == 'success') {
                return Redirect::to('adminPricing/index/')->with('flash_message', 'scheme created');
            } else {
