...
<span class="main-title">{{ $property->property_name }}</span> <small>更新 - {{$property->property_updated_at}}</small>
<br/>
...
<div class="ul-wrapper">
  <ul class="std-ul">
    ...
    <li class=""><span class="std-bold">售價: <span class="pull-right">{{$property->property_price}} 萬</span></span></li>
    @endif
    @if($property->property_rentprice != 0)
    <li class=""><span class="std-bold">租金: <span class="pull-right">{{$property->property_rentprice}} 千</span></span></li>
    @endif
