        ...
        <div class="std-border white-bg std-padding">
            ...
            <div collapse="!isCollapsed">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        'class'=>'form-control', 'placeholder'=>'再輸入新密碼')) }}
                    </div>
                </div>
            ...
            <div class="two-col-panel">
                ...
                <div class="left-panel center">
                    ...
                    {{ HTML::image('profilepic/' . $account->profile_pic, $account->firstname . $account->lastname,
                    array('class' => '')) }}
                    @else
            ...
            {{ Form::open(array('url'=>'account/edit', 'class'=>'form-horizontal')) }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    {{Form::text('firstname', $account->firstname, array('id' => 'inputFirstname' ,
                    'class'=>'form-control', 'placeholder'=>'名字'))}}
                </div>
                <label for="inputLastname" class="col-sm-2 control-label">姓名</label>

                <div class="col-sm-4">
                    {{ Form::text('lastname', $account->lastname, array('id' => 'inputLastname' ,
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    {{ Form::text('cell_tel', $account->cell_tel, array('id' => 'inputCellPhone' ,
                    'class'=>'form-control', 'placeholder'=>'號碼')) }}
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    'class'=>'form-control', 'placeholder'=>'入行年資 經驗 負責地區等')) }}
                </div>
            </div>
