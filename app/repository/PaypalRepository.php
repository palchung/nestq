...
class PaypalRepository {
        ...
        public function PPHttpPost($methodName_, $nvpStr_) {
                ...
                $API_UserName = urlencode(Config::get('nestq.PAYPAL_USERNAME'));
                $API_Password = urlencode(Config::get('nestq.PAYPAL_PASSWORD'));
                $API_Signature = urlencode(Config::get('nestq.PAYPAL_SIGNATURE'));
