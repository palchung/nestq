...
$options = array(
    'upload_dir' => DIR_DOWNLOAD . '/nestq/public/upload/' . $_SESSION['photofolder'] . '/',
    'upload_url' => HTTP_SERVER . '/nestq/public/upload/' . $_SESSION['photofolder'] . '/',
    'image_versions' => array(
        'thumbnail' => array(
            'upload_dir' => DIR_DOWNLOAD . '/nestq/public/upload/' . $_SESSION['photofolder'] . '/thumbnail/',
            'upload_url' => HTTP_SERVER . '/nestq/public/upload/' . $_SESSION['photofolder'] . '/thumbnail/',
            'max_width' => 80,
            'max_height' => 80
        ),
    ),
